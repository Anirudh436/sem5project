...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if (formData.imageUrls.length < 1) return setError("You must submit atleast 1 image!");
    ...
    return (
        <main className='min-h-screen p-3 max-w-4xl mx-auto overflow-hidden'>
            <h1 className='font-semibold text-3xl text-center my-7'>Create a Listing</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4 overflow-auto max-h-screen'>
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className='flex flex-wrap gap-6  '>
                        ...
                        <div className='flex items-center gap-2'>
                            <input type="number" id='regularPrice' min='5000' max='1000000000' required className='p-3 border border-gray-300 rounded-lg ' onChange={handleChange} value={formData.regularPrice} />
                        ...
                        {formData.offer && (
                            <div className='flex items-center gap-2'>
                                <input type="number" id='discountedPrice' min='0' max='100000000' required className='p-3 border border-gray-300 rounded-lg ' onChange={handleChange} value={formData.discountedPrice} />
                                <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button type='button' disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-70'>
